...
HD_PWD='C:/Users/Karlsen/Sep-repository-2/HW_Base_Booster_2025/Proyecto_Base_Booster_2025.runs/DEMO_state_machine_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_state_machine_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_state_machine_0_1.tcl
