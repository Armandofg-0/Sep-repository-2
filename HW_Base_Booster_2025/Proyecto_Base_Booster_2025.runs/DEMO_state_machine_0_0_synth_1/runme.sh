...
HD_PWD='C:/Users/Karlsen/Sep-repository-2/Proyecto_Base_Booster/HW_Base_Booster_2025/Proyecto_Base_Booster_2025.runs/DEMO_state_machine_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_state_machine_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_state_machine_0_0.tcl
